...
public class CharacterAimHandler : MonoBehaviour, EnemyHandler.IEnemyTargetable {
	...
	private void Start () {
        V_Object vObject = CreateBasicUnit(transform, new Vector3(500, 680), 30f, null);
        ...
        V_UnitSkeleton_Composite_Weapon unitSkeletonCompositeWeapon = new V_UnitSkeleton_Composite_Weapon(vObject, unitSkeleton, BaseGameAssets.UnitAnimEnum.dMarine_AimWeaponRight, BaseGameAssets.UnitAnimEnum.dMarine_AimWeaponRightInvertV, BaseGameAssets.UnitAnimEnum.dMarine_ShootWeaponRight, BaseGameAssets.UnitAnimEnum.dMarine_ShootWeaponRightInvertV);
        vObject.AddRelatedObject(unitSkeletonCompositeWeapon);
        unitSkeletonCompositeWeapon.SetActive();
            
        V_UnitSkeleton_Composite_Walker unitSkeletonCompositeWalker_BodyHead = new V_UnitSkeleton_Composite_Walker(vObject, unitSkeleton, BaseGameAssets.UnitAnimTypeEnum.dMarine_Walk, BaseGameAssets.UnitAnimTypeEnum.dMarine_Idle, new[] { "Body", "Head" });
        vObject.AddRelatedObject(unitSkeletonCompositeWalker_BodyHead);
            
        V_UnitSkeleton_Composite_Walker unitSkeletonCompositeWalker_Feet = new V_UnitSkeleton_Composite_Walker(vObject, unitSkeleton, BaseGameAssets.UnitAnimTypeEnum.dMarine_Walk, BaseGameAssets.UnitAnimTypeEnum.dMarine_Idle, new[] { "FootL", "FootR" });
        ...
        FunctionUpdater.Create(() => {
            ...
            if (canShoot && Input.GetMouseButton(0)) {
                ...
                unitSkeleton.ReplaceBodyPartSkeletonAnim(BaseGameAssets.UnitAnimTypeEnum.dMarine_Attack.GetUnitAnim(aimDir), "Body", "Head");
