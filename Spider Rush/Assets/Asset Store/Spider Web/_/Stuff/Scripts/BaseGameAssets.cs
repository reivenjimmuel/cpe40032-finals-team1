...
public class BaseGameAssets : MonoBehaviour {

    private static BaseGameAssets _i;

    public static BaseGameAssets i {
        get {
            if (_i == null) _i = Instantiate(Resources.Load<BaseGameAssets>("BaseGameAssets"));
            return _i;
        }
    }
